...
1. 请确认Grafana的插件目录位置。在Centos的插件目录/var/lib/grafana/plugins/安装插件，重启grafana-server。
   ...
   wget https://github.com/TencentCloud/cls-grafana-datasource/releases/download/v0.2.0/tencent-cls-grafana-datasource.zip
...
docker run -d -p 3000:3000 --name=grafana6 \
  -e "GF_INSTALL_PLUGINS=https://github.com/TencentCloud/cls-grafana-datasource/releases/download/v0.2.0/tencent-cls-grafana-datasource.zip;tencent-cls-grafana-datasource,https://github.com/grafana/piechart-panel/releases/download/v1.6.4/grafana-piechart-panel-1.6.4.zip;grafana-piechart-panel" \
...
services:
  grafana:
    ...
    ports:
      - '3000:3000'
    environment:
      - GF_INSTALL_PLUGINS=https://github.com/TencentCloud/cls-grafana-datasource/releases/download/v0.2.0/tencent-cls-grafana-datasource.zip;tencent-cls-grafana-datasource,https://github.com/grafana/piechart-panel/releases/download/v1.6.4/grafana-piechart-panel-1.6.4.zip;grafana-piechart-panel
