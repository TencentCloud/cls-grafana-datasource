...
![安装插件](./docs/images/install-plugin.png)
...
2. 左侧菜单栏点击设置图标，进入**Data Sources**
   ...
   | SecretId, SecretKey | API请求密钥，用于身份鉴权。获取地址前往[API密钥管理](https://console.cloud.tencent.com/cam/capi)。凭证类型为“永久密钥”或“Assume Role”时填写。<br>建议参考[推荐权限策略](https://cloud.tencent.com/document/product/614/68374#cls-.E5.AF.B9.E6.8E.A5-grafana)创建子账号并使用其密钥。                                                                                                                                               |
   | RoleArn             | 角色的资源描述，可在[访问管理](https://console.cloud.tencent.com/cam/role)，点击角色名获取。凭证类型为“Assume Role”时填写。<br>建议参考[推荐权限策略](https://cloud.tencent.com/document/product/614/68374#cls-.E5.AF.B9.E6.8E.A5-grafana)为该角色授权。                                                                                                                                            |
   | 角色名称             | 角色名称，可在[访问管理](https://console.cloud.tencent.com/cam/role)获取。凭证类型为“CVM Role”时填写。必须与CVM绑定的角色名一致。<br>建议参考[推荐权限策略](https://cloud.tencent.com/document/product/614/68374#cls-.E5.AF.B9.E6.8E.A5-grafana)为该角色授权。                                                                                                                                         |
   | 语言                  | 插件展示语言                                                                                                                                                                                                                                                 |
   | 开启内网API模式           | 是否通过内网访问云API                                                                                                                                                                                                                                           |
   | 在探索页开启展示类型选项        | 在探索页开启展示类型选项，控制探索页展示的图表类型                                                                                                                                                                                                                              |

   ![配置数据源](./docs/images/configure-datasource.png)
...
2. 数据源选择用户刚刚新建的CLS datasource
   ...
   ![选择数据源](./docs/images/select-datasource.png)
...
![Custom类型变量](./docs/images/variable-custom.png)
...
* | select status
```
![Query类型变量](./docs/images/variable-query.png)
...
![云API列表类型变量](./docs/images/variable-cloudapi.png)
![云API列表类型变量效果](./docs/images/variable-cloudapi-effect.png)
...
![Datasource类型变量](./docs/images/variable-datasource.png)
